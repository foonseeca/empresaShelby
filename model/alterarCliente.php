...
if(isset($_POST['editar'])){
    ...
    $query_update = "UPDATE clientes SET nome=:nome, email=:email, senha=:senha, celular=:celular, telefone=:telefone, cep=:cep, cidade=:cidade, bairro=:bairro, rua=:rua, numero=:numero, complemento=:complemento WHERE id_cliente=:id_cliente";
