        ...
        <form action="../model/cadastroGeral.php" method="POST">
            <div class="row">
                ...
                <div class="input-field col s12 m2 l2">
                    ...
                    <input name="nascimento" id="nascimento" type="text" placeholder="2000/09/05" class="inputDark">
                ...
                <div class="input-field col s12 m3 l3">
                    ...
                    <input name="cpf" id="cpf" type="text" placeholder="183.847.957-85" class="inputDark">
            ...
            <div class="row">
                ...
                <div class="input-field col s12 m2 l2">
                    ...
                    <input name="email" id="email" type="password" placeholder="*********" class="inputDark">
                ...
                <div class="input-field col s12 m2 l2">
                    ...
                    <input name="celular" id="celular" type="text" placeholder="(11) 97765-3360" class="inputDark">
                    <label id="lbl" class="active" for="first_name">Celular</label>
                </div>
                <div class="input-field col s12 m2 l2">
                    <i class="material-icons prefix dark">call</i>
                    <input name="telefone" id="telefone" type="text" placeholder="(11) 4002-8922" class="inputDark">
            ...
            <div class="row">
                <div class="input-field col s12 m3 l2">
                    ...
                    <input name="cep" id="cep" placeholder="ex: 08574-150" type="text" class="inputDark" onblur="pesquisacep(this.value);">
